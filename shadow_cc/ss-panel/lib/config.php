...
define('DB_HOST','strkly-shadow.cpkndyalguap.ap-northeast-1.rds.amazonaws.com');
define('DB_USER','shadow');
define('DB_PWD','strikinglygo');
...
//name
$site_name = "Strikingly-Shadow";
$site_url  = "https://www.strikingly.com/";
/**
 * 站点盐值，用于加密密码
